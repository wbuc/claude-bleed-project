...
{Colors.DIM}Right now you're using web search only. Add API keys to unlock:{Colors.RESET}
  ...
  {Colors.YELLOW}🟠 Reddit{Colors.RESET} - Real upvotes, comments, and community insights
     └─ Add BRAVE_API_KEY (uses Brave Search for Reddit discovery)

  {Colors.CYAN}🔵 X (Twitter){Colors.RESET} - Real-time posts, likes, reposts from creators
     └─ Add XAI_API_KEY (uses xAI's live X search)

{Colors.DIM}Setup:{Colors.RESET} Edit your project {Colors.BOLD}.env{Colors.RESET} file
{Colors.YELLOW}{Colors.BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{Colors.RESET}
"""
...
Setup: Edit your project .env file
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
PROMO_SINGLE_KEY = {
    "reddit": f"""
{Colors.DIM}💡 Tip: Add {Colors.YELLOW}BRAVE_API_KEY{Colors.RESET}{Colors.DIM} to your .env for Reddit data with real engagement metrics!{Colors.RESET}
""",
    "x": f"""
{Colors.DIM}💡 Tip: Add {Colors.CYAN}XAI_API_KEY{Colors.RESET}{Colors.DIM} to your .env for X/Twitter data with real likes & reposts!{Colors.RESET}
""",
}

PROMO_SINGLE_KEY_PLAIN = {
    "reddit": "\n💡 Tip: Add BRAVE_API_KEY to your .env for Reddit data with real engagement metrics!\n",
    "x": "\n💡 Tip: Add XAI_API_KEY to your .env for X/Twitter data with real likes & reposts!\n",
}
